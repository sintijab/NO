...
const loadSimpleWebRTC = (src) => {
  ...
  script.onload = () => {
    ...
    webrtc.on('localMediaError', () => {
      console.log('This service only works if you allow camera access.Please grant access and refresh the page.')
    })
...
export default loadSimpleWebRTC
